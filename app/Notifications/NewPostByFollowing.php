...
/**
 * Notification sent when someone you follow creates a new post
 */
class NewPostByFollowing extends Notification
{
    use Queueable;
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'message' => ($this->clip->user->name ?? 'Someone') . ' posted a new clip',
